    ...
    return (
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between relative w-full gap-8 lg:gap-0 mt-8 mb-16">
            ...
            <div className="hidden lg:block absolute top-[60px] left-[10%] right-[10%] h-0.5 bg-border/40 z-0">
                <motion.div
                    className="h-full"
                    style={{ background: 'linear-gradient(90deg, #E8441A, #FF6B35)' }}
                    initial={{ width: 0 }}
            ...
            {phases.map((phase, idx) => {
                ...
                return (
                    <div key={phase.id} className="relative z-10 flex flex-col items-center w-full lg:w-1/5 group">
                        <Link href={isLocked ? "#" : `/module/${firstIncomplete}`}>
                            ...
                            >
                                <div className="relative mb-3 flex items-center justify-center">
                                    ...
                                    {isCompleted ? (
                                        <div className="absolute inset-0 m-auto w-12 h-12 rounded-full flex items-center justify-center bg-green-500/20 text-green-500">
                                            <CheckCircle2 className="w-6 h-6" />
                                        </div>
                                    ) : isInProgress ? (
                                        <div className="absolute inset-0 m-auto w-12 h-12 rounded-full flex items-center justify-center text-orange-500">
