        ...
        // ── Lesson 8.2.1 ──────────────────────────────────────
        {
          ...
          concept: {
            ...
            explanation: [
              ...
              'Occupancy measures the ratio of the number of active Wavefronts on a CU to the maximum possible value. Each CU has limited resources: RDNA3 has a maximum of 16 Wave32 (or 8 Wave64) per CU, which is limited by VGPR (192KB/CU, each Wave32 has a maximum of 256 VGPR × 32 lane × 4 bytes = 32KB), LDS (64KB/CU, shared between blocks) and the upper limit of the number of blocks. The higher the occupancy, the more the GPU can hide memory latency by switching Wavefront. Use hipOccupancyMaxPotentialBlockSize to calculate the optimal block size for a given kernel function (rocm_agent_enumerator only enumerates HSA agents and has nothing to do with occupancy).',
            ],
            keyPoints: [
