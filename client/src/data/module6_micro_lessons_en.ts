        ...
        // ── Lesson 6.1.1 ──────────────────────────────────────
        {
          ...
          concept: {
            ...
            explanation: [
              ...
              'Dynamic debugging is a powerful feature of the Linux kernel that allows pr_debug() and dev_dbg() output to be precisely switched by module, file, function or line number at runtime. The official interface is /proc/dynamic_debug/control: echo "module amdgpu +p" turns on all pr_debug output of amdgpu, echo "file amdgpu_device.c +p" turns on only specific files. This is much more efficient than recompiling the kernel.',
        ...
        return r;
          ...
          miniLab: {
            ...
            steps: [
              ...
              'Enable amdgpu dynamic debugging: sudo sh -c \'echo "module amdgpu +p" > /proc/dynamic_debug/control\'',
              ...
              'Turn off debug output when finished: sudo sh -c \'echo 0 > /sys/module/drm/parameters/debug\' && sudo sh -c \'echo "module amdgpu -p" > /proc/dynamic_debug/control\'',
            ],
