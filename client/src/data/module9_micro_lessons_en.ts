...
; → Total Occupancy = min(100%, 100%) = 100% ★ Optimal`,
          ...
          miniLab: {
            ...
            steps: [
              ...
              'Calculate Occupancy using ROCm tool: rocm-smi --showoccupancy or manually calculate 1536÷VGPR_count',
