...
// 6 lessons in 3 groups, ~15-20 min each, total ~100 min
// ============================================================
...
int amdgpu_device_ip_init(struct amdgpu_device *adev)
{
    ...
    return 0;
          ...
          miniLab: {
            ...
            objective: '通过 debugfs 查看你的 RX 7600 XT 上实际运行的所有 IP Block，验证代码中的 IP Block 注册。',
