...
export const cCppModuleEn: Module = {
  ...
  icon: 'Braces',
  description: 'Before diving into kernel code, systematically review the C you actually need for driver work, then progressively learn the C++ core relevant to the GPU software stack. Foundations-first, depth-oriented, with hands-on labs, connecting every concept to real amdgpu / Mesa / ROCm / LLVM code.',
  estimatedHours: 42,
  difficulty: 'beginner',
  subModules: [
